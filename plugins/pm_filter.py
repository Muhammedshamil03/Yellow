...
# kanged From @MalluMoviesGroupMalayalam
import asyncio
import re
import ast
...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, DL_TIME
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 Updates', url='https://t.me/+vGksUgFYzV9kNjE1')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('🤖 Movies', url='https://t.me/+vFWkkbTGdDE5YjBl'),
